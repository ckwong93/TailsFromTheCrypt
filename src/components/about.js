    ...
    return (
      <div>
        <div>
          ...
          <div className="col-xs-12 col-md-8 margintop">
            <blockquote>
              From Wikipedia - "Cryptocurrencies are digital assets designed to work as mediums of exchange using cryptography to secure the transactions and to control the creation of additional units of the currency.
             ...
             <br></br><center>
               <Button className="custom-button" bsStyle="warning" >Bitcoin</Button> &nbsp; &nbsp;
